...
export default function Navbar({connectWallet, disconectWallet, Address, setAddress}) {
  return (
    <div>
        <div>
            <div>
                <nav class="bg-gray-800 border-gray-200 px-6 sm:px-4 pt-6 dark:bg-gray-800">
                    ...
                    {Address !== null &&
                        <button type="submit" onClick={disconectWallet} class="text-white text-lg bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"> Disconnect </button>
                    }
